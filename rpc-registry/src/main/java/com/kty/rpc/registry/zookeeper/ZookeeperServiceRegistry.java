package com.kty.rpc.registry.zookeeper;
...
public class ZookeeperServiceRegistry implements ServiceRegistry {
    ...
    /**
     * 该构造方法提供给用户（用户通过配置文件字典里个 zkAddress 完成服务注册组件的注入）
     * @param zkAddress
     */
    ...
    public void register(String serviceName, String serviceAddress) {
        // 创建register 持久节点，该节点下存放所有的 service 节点
        ...
        // 在 service 节点创建 address 临时节点，存放服务器地址
