package com.kty.rpc.sample.client;

import com.kty.rpc.client.RpcProxy;
...
public class HelloClient {
    ...
    public static void main(String[] args) {
        ...
        String result2 = helloServiceImpl2.hello("帅峰");
