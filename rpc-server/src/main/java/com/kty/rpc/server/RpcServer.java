package com.kty.rpc.server;

import com.kty.codec.RpcDecoder;
import com.kty.codec.RpcEncoder;
import com.kty.entity.RpcRequest;
import com.kty.entity.RpcResponse;
import com.kty.rpc.registry.ServiceRegistry;
...
public class RpcServer implements ApplicationContextAware, InitializingBean {
    ...
    // 服务地址（比如服务被暴露在 Netty 的8000端口，服务地址就是 127.0.0.1:8000）
    ...
    /**
     * Spring 容器在加载的时候会自动调用一次 setApplicationContext, 并将上下文 ApplicationContext 传递这个方法
     * 该方法的作用就是获取带有 @RpcService 注解的类的 value （被暴露的失效类的接口名称）和 version （被暴露的实现类的版本号，默认为
        ...
        try {
            ...
            serverBootstrap.childHandler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel socketChannel) throws Exception {
                    ...
                    pipeline.addLast(new RpcEncoder(RpcResponse.class)); // 解码器
